<template>
  <div class="ServiceHeader">
    ...
    <v-container>
      ...
      <GoogleAcademicServiceResultsComponent v-if="showResults" :results="fields" />
    </v-container>
  </div>
</template>
...
import GoogleAcademicServiceResultsComponent from './GoogleAcademicServiceResultsComponent.vue'
