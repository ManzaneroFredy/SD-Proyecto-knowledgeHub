<template>
  <div class="ServiceHeader">
    ...
    <v-container>
      ...
      <EBSCOServiceResultsComponent v-if="showResults" :results="fields" />
    </v-container>
  </div>
</template>
...
import EBSCOServiceResultsComponent from './EBSCOServiceResultsComponent.vue'
